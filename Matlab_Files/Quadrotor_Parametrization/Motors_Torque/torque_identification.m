...
%%
figure(3);
plot(motor1_test1(:,4), motor1_test1(:,3).*g*0.24/1000);
hold on;
plot(motor1_test2(:,4), motor1_test2(:,3).*g*0.24/1000);
hold on;
plot(motor1_test3(:,4), motor1_test3(:,3).*g*0.24/1000);
hold on;
plot(motor1_test4(:,4), motor1_test4(:,3).*g*0.24/1000);
hold on;
plot(motor1_test5(:,4), motor1_test5(:,3).*g*0.24/1000);
hold on;
plot(motor1_test6(:,4), motor1_test6(:,3).*g*0.24/1000);
hold on;
plot(motor1_test7(:,4), motor1_test7(:,3).*g*0.24/1000);
hold on;
thrust = linspace(0,5.8);
%drag = 8.7804.*thrust;
drag = 0.0207.*thrust;
line(thrust,drag,'Color','black','LineWidth',1);
%text(1,30, '$$y = 8.7804x$$','Interpreter','latex');
text(1,0.1, 'Drag Force [Nm] $$= 0.0207*$$Thrust','Interpreter','latex');
xlabel('Thrust [N]');
