...
print -depsc2 auto_psi_lqi_imp.eps
%%
figure(2);
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_theta_lqi_imp.eps
%%
figure(3);
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_phi_lqi_imp.eps
%%
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_z_lqi_imp.eps
%%
figure(5);
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_x_lqi_imp.eps
%%
figure(6);
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_y_lqi_imp.eps
...
set(lgd,'Interpreter','latex','Location','northeast')
axis([-0.2 2.2 -0.2 2.2 1 5])
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_xyz_lqi_imp.eps
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_pwm1_lqi_imp.eps
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_pwm2_lqi_imp.eps
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_pwm3_lqi_imp.eps
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_pwm4_lqi_imp.eps
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_u_lqi_imp.eps
%%
figure(13);
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_taupsi_lqi_imp.eps
%%
figure(14);
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_tautheta_lqi_imp.eps
%%
figure(15);
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_tauphi_lqi_imp.eps
%%
figure(16);
...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_errorpos_lqi_imp.eps
