...
%   - total_time
    ...
    spYaw = spline(t_full,Yawwaypoints,t);
    spRoll = zeros(size(spYaw));
    spPitch = zeros(size(spYaw));
    
    desired_Traj = [spX; spY; spZ; spYaw; spRoll; spPitch];
