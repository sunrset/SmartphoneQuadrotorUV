...
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_theta_lqi.eps
%%
figure(3);
...
set(lgd,'Interpreter','latex','Location','southeast')
axis([0 70 -0.06 0.035])
a = get(gca,'XTickLabel');
set(gca,'TickLabelInterpreter', 'latex','fontsize',18)
print -depsc2 auto_phi_lqi.eps
%%
figure(4);
