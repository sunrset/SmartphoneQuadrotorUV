\chapter{Quadrotor Components and Parameter Identification} \label{ch:prototype}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=6.6cm]{phonesupport2.png}    
...
\begin{subfigure}{.5\linewidth}
\centering
\includegraphics[width=6.0cm]{megasupport2.png}
\caption{Arduino Mega ADK support} 
\label{fig:megasupport}
\end{subfigure}%
\begin{subfigure}{.5\linewidth}
\centering
\includegraphics[width=6.0cm]{escsupport2.png}
\caption{ESCs support} 
\label{fig:escsupport}
\end{subfigure}\\[1ex]
\begin{subfigure}{\linewidth}
\centering
\includegraphics[width=6.0cm]{megaandescsupport2.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=7.6cm]{dome2.png}    
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=11cm]{complete.jpg}    
