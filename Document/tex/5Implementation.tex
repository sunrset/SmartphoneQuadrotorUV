...
\section{Ground Control Station}\label{sec:gcs}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.55\textwidth]{commGCS.jpg}  
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.55\textwidth]{tripod.jpg}  
...
%\centering
%\includegraphics[height=8.0cm]{tripod1.jpg}
%\caption*{}
%\label{fig:tripod1}
%\end{subfigure}
%\begin{subfigure}{.4\linewidth}
%\centering
%\includegraphics[height=8.0cm]{tripod.jpg}
%\caption*{}
%\label{fig:tripod2}
%\end{subfigure}
%\caption{Test bench for stabilize mode tests} 
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.55\textwidth]{flyingQuad1.jpg}  
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.65\textwidth]{flyingQuad2.jpg}  
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.6\textwidth]{auto_xyz_lqi_imp}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.6\textwidth]{auto_xyz_h_imp}
