 ...
 */
public class QuadPositionRenderer implements WaypointRenderer<MyWaypoint>
{
	private static final Log log = LogFactory.getLog(QuadPositionRenderer.class);
...
//	private final Font font = new Font("Lucida Sans", Font.BOLD, 10);
	 ...
	 */
	public QuadPositionRenderer()
	{
		URL resource = getClass().getResource("/QuadWaypoint.png");
		...
		{
			log.warn("couldn't read QuadWaypoint.png", ex);
		}
	}
