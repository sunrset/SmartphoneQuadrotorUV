...
const int SE_PWM_PIN = 4;   //S1 in ESC, Motor 2 in Model  4
const int NE_PWM_PIN = 5;   //S2 in ESC, Motor 1 in Model  5
const int NW_PWM_PIN = 6;   //S3 in ESC, Motor 4 in Model  6
const int SW_PWM_PIN = 7;   //S4 in ESC, Motor 3 in Model  7
